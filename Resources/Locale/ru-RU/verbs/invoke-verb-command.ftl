...
invoke-verb-command-description = Вызывает глагол (действие) с заданным именем на сущности, с сущностью игрока
...
invoke-verb-command-success = Вызывает глагол (действие) '{ $verb }' на { $target } с { $player } в качестве пользователя.
invoke-verb-command-verb-not-found = Не удалось найти глагол (действие) { $verb } на { $target }.
