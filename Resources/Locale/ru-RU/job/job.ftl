...
job-greet-important-disconnect-admin-notify = Вы играете важную роль для игрового процесса. Если вы вынуждены отключиться, пожалуйста, сообщите об этом администраторам через «Админ Помощь» (AHelp), F1 по умолчанию.
