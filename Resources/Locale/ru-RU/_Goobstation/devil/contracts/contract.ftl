devil-contract-contractee = подписант
devil-contract-contractor = подрядчик

devil-contract-early-sign-failed = Подрядчик должен дождаться, пока первым распишется подписант!
...
default-contract-content = Настоящим заключён обязывающий контракт между:

            - Стороной Инфернальной (именуемой далее «Подрядчик»)
            - Стороной Смертной (именуемой далее «Подписант»)

            {"["}bold]ОБЯЗУЮЩИЕ ПУНКТЫ:{"["}/bold]
            {"["}italic]Следующие стороны передают следующие владения{"["}/italic{"]"}

            Подписант: Soul Ownership
            Подписант: Death
