telecrystal-miner-announcement = Криптографический анализ трафика зафиксировал добычу нелегальной валюты на станции. Персоналу следует немедленно найти и уничтожить устройство, посредством которого совершается добыча.
