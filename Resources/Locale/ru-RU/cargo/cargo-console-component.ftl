...
cargo-console-unlock-approved-order-broadcast = [bold]Заказ на { $productName } в количестве { $orderAmount }шт.[/bold] и общей стоимостью [bold]{ $cost }$[/bold] одобрил сотрудник [bold]{ $approver }[/bold]
