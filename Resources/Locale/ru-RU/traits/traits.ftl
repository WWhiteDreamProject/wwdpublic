...
trait-desc-StudioVisor = Ваша визуальная система КПБ была обновлена студийным визором высокого качества, который устраняет большинство CRT-эффектов, но сохраняет минимальные глитчи при получении урона или низком заряде.
