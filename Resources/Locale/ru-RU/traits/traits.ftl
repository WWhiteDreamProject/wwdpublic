...
trait-description-FlareShielding =
    Ваши киберглаза оснащены фотохромными линзами, которые автоматически затемняются в ответ на интенсивные раздражители.
    Это обеспечивает защиту от, например, сварочных дуг, но не от более интенсивных источников света.
...
trait-name-FlareShieldingModule = Глазной Модуль КПБ: Защита матрицы
