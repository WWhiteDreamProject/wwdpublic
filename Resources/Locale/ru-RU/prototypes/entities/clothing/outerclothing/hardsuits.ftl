...
ent-ClothingOuterHardsuitJuggernaut = костюм джаггернаута Cybersun
    .desc = Костюм, созданный отделом передовых исследований и разработок компании Cybersun, обладает повышенной устойчивостью к внешнему воздействию. Мощный экзоскелет позволяет владельцу двигаться несмотря на полученные травмы.
    .suffix = { "" }
