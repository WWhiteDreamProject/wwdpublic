...
ent-WeaponShotgunEnforcer = Силовик
    .desc = Боевой дробовик премиум-класса, созданный на основе конструкции Каммерера, с полуавтомаической системой заряжания. Использует патроны калибра .50 ружейный.
    .suffix = Дробовик
