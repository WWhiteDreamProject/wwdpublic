...
ent-DisposableSyringe = одноразовый шприц
    .desc = Используется для введения мобам контролируемых доз определенных реагентов. Одноразовый.
    .suffix = { "" }
ent-SyringeCryostasis = криостазисный шприц
    .desc = Шприц, используемый для содержания химикатов или растворов без протекания реакций.
    .suffix = { "" }
