...
ent-OmnimedTool = медицинский мультитул
    .desc = Сложный, усовершенствованный медицинский многофункциональный инструмент, разработанный Nanotrasen для ускорения времени работы и экономии места.
    .suffix = { "" }
...
ent-OmnimedToolSyndie = { ent-OmnimedTool }
    .desc = Сложный, усовершенствованный медицинский многофункциональный инструмент, разработанный Синдикатом для ускорения времени работы и экономии места.
    .suffix = { "" }
...
ent-AdvancedRetractor = механические зажимы
    .desc = Ретрактор с механическими зажимами, в включенном состоянии также выполняет роль гемостата.
    .suffix = { "" }
