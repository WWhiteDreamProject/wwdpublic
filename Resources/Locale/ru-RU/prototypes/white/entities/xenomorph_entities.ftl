...
alien-larva-greeting = Вы - грудолом. Помогите своему улью расширяться. Если вы первый, или последний в своём улье - найдите безопасное место, для нового улья и эволюционируйте в ДРОНА, иначе рой не сможет продолжить своё существование.
alien-hunter-greeting = Вы - охотник. Найдите лицехватов и бросайте их в носителей. Пожирайте людей и доставляйте их в свой улей.
alien-drone-greeting = Вы - дрон. Постройте свой улей, эволюционируйте в преторианца, если вы будете первым.
alien-sentinel-greeting = Вы - плевальщик. Защищайте свой улей, сражайтесь с незваными гостями.
alien-praetorian-greeting = Вы - преторианец. Защитите свою королеву. Помогите построить новые ульи. Станьте королевой, если ее еще нет.
alien-queen-greeting = Вы - королева ксеноморфов. Управляйте своим ульем, откладывайте яйца. ОСТАВАЙТЕСЬ В ЖИВЫХ.
alien-maid-greeting = Вы - ксено-горничная. Будьте похотливыми. Выполняй самую важную работу в своем улье - соблазняйте космонавтиков.
