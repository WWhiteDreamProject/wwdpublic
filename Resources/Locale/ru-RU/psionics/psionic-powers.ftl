...
noospheric-zap-power-metapsionic-feedback =
    Я заглядываю в сердце {CAPITALIZE($entity)}, и нахожу там мерцающий осколок чистой энергии — затаившееся существо, исполненное ненависти к плоти.
...
psionic-regeneration-power-initialization-feedback =
    Я заглядываю в себя — и нахожу там источник жизни, бьющий, как сердце вселенной.
...
telekinetic-pulse-power-initialization-feedback =
    Протянув руку сквозь завесу, я нашёл источник чистой силы движения. Она бурлит во мне, но я не в силах полностью её контролировать.
telekinetic-pulse-power-metapsionic-feedback = В {CAPITALIZE($entity)} течёт сама суть кинеза.

# Пирокинетическая Вспышка
...
darkswap-power-initialization-feedback =
    Лишь на миг мне позволено разорвать завесу миров. Я скольжу в тенях, готовый шагнуть в самую бездну...
ethereal-pickup-fail = Моя рука шипит, проходя сквозь...

# Псионический фамильяр
...
ghost-role-information-familiar-description = Межпространственное существо, связанное с волей псионика.
ghost-role-information-familiar-rules =
    Повинуйся тому, кто вызвал тебя. Не действуй вопреки воле Повелителя. Умри за него, если потребуется.
