...
ent-VendingMachineBoxingDrobe = Боксомат
    .desc = Торговый автомат для боксёрской одежды.
    .suffix = { "" }
ent-VendingMachineCourierDrobe = КурьерШкаф
    .desc = Идеальная, прочная и удобная одежда для курьеров! О да, самое то!
    .suffix = { "" }
ent-VendingMachineCuraDrobe = КураДроб
    .desc = Одежда для длительных посиделок за книжками только тут!
    .suffix = { "" }
ent-VendingMachineDrGibb = Напитки Доктора Гибба
    .desc = Напитки от всеми известного Доктора Гибба! (Примечание: Врачи не рекомендуют пить данные напитки, пейте на свой страх и риск.)
    .suffix = { "" }
ent-VendingMachineMNKDrobe = АмиДроб
    .desc = Спортивная одежда от компании «Амидас».
    .suffix = { "" }
ent-VendingMachineAutomatrobe = ТургоШкаф
    .desc = Торговый автомат одежды для автоматурга.
    .suffix = { "" }
ent-VendingMachineAutomatrobe = ТургоШкаф
    .desc = Торговый автомат одежды для автоматурга.
    .suffix = { "" }
ent-VendingMachineSolsnack = СолМат
    .desc = Закуски прямо из Солнечной системы!
    .suffix = { "" }
ent-VendingMachinePride = ГееМат
    .desc = Боже правый, как оно сюда попало?..
    .suffix = { "" }
ent-VendingMachineRepDrobe = РепоШкаф
    .desc = Торговый автомат одежды для репортёра.
    .suffix = { "" }
ent-VendingMachineFitness = СпортДроб
    .desc = Одежда для спорта! Содержит на 99% больше белка!
    .suffix = { "" }
ent-VendingMachineChemicalsSyndicate = СиндиХимия
    .desc = Совершенно точно не продаёт химикаты и реагенты для Синдиката.
    .suffix = { "" }
ent-VendingMachineHotfood = Горячие закуски
    .desc = Старый торговый автомат, предлагающий «горячие блюда». Вы сомневаетесь, что его содержимое ещё съедобно.
    .suffix = { "" }
