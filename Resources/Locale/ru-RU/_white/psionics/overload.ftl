...
psionic-punishment-tier1 = Голоса затихают, мой разум пуст.
psionic-punishment-tier2 = Сосуд моей души искажается, оставляя меня в заточении без способа ответа.
psionic-punishment-tier3 = Занавес падает. Свет разума гаснет.
psionic-punishment-tier4 = Нить моей судьбы обрывается.
