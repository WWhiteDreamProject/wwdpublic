...
# Traitor Rich
aspect-traitor-rich-briefing = Поздравляем! Было решено выделить вам 10 дополнительных телекристаллов.

# AdminLog
aspect-admin-log-added = Аспект добавлен: { $aspect }
aspect-admin-log-started = Аспект запущен: { $aspect }
aspect-admin-log-ended = Аспект завершен: { $aspect }

run-aspect-admin = { $admin } запустил аспект { $rule }

# Announcement
aspect-announcement-ended = Название аспекта: { $aspect }
