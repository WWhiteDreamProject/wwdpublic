...
xenomorphs-no-more-threat-announcement = Судя по данным наших датчиков дальнего действия, все ксеноморфы способные к размножению были устранены.
...
xenomorphs-cond-xenoinfiltratedoncentcom = Ксеноморфы способные к размоножению пробрались на станцию центрального командывания.
...
xenomorphs-list-start = Ксеноморфами были:
xenomorphs-list-name-user = - [color=#8c3986]{ $name }[/color] ([color=gray]{ $user }[/color])
