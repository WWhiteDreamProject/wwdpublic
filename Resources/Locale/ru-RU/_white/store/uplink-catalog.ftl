...
uplink-hardlight-spear-implant-desc = Имплант, вводимый в тело и активируемый по желанию пользователя. Он вызывает копье из твердого света, с помощью которого пользователь может сеять хаос. Наши технологии настолько хороши что мы имеем световые копья, но хирурги из нас говнявые.
