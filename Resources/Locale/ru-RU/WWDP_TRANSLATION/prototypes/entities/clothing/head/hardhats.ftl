...
ent-ClothingHeadHatHardhatYellow = желтая рабочая каска
    ...
    .suffix = { "" }
ent-ClothingHeadHatHardhatGreen = зелёная рабочая каска
    .desc = Окрашенная в зелёный цвет каска, используемая при опасных условиях труда для защиты головы. Имеет встроенный фонарик.
    .suffix = { "" }
