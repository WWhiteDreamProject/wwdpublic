...
ent-AnomalyCoreFlesh = { ent-BaseAnomalyCore }
    .desc = Ядро уничтоженной плотяной аномалии. Тошнотворно пульсирует, но может стать сытной едой, если приготовить.
    .suffix = { "" }
...
ent-AnomalyCoreFleshInert = { ent-BaseAnomalyCore }
    .desc = Инертное ядро уничтоженной плотяной аномалии. Тошнотворно пульсирует, но в умелых руках может стать хорошей едой?
    .suffix = { "" }
