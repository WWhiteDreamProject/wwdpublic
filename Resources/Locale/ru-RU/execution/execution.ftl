...
execution-popup-self-initial-external = {$attacker} заносит {POSS-ADJ($attacker)} {$weapon} над своим горлом.
execution-popup-self-complete-internal = Вы перерезаете себе горло при помощи {$weapon}!
execution-popup-self-complete-external = {$attacker} перерезает себе горло при помощи {$weapon}!
