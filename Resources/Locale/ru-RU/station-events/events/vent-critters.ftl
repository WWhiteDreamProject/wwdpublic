station-event-snail-migration-announcement = Внимание. На станции обнаружен большой поток неизвестных форм жизни, обитающих в вентиляционных системах. Избавьтесь от этих существ, прежде чем это начнет влиять на эффективность работы станции.
station-event-snail-migration-low-pop-announcement = Внимание. В вентиляционных системах станции обнаружен большой поток неизвестных форм жизни. Избавьтесь от этих существ, прежде чем это начнет влиять на эффективность работы станции.
