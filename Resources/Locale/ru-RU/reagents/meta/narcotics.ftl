...
reagent-desc-liftloversspecial = Химический коктейль, который быстро восстанавливает выносливость. Несмотря на официальный запрет данного стероида, он остается популярным напитком на черном рынке среди любителей фитнеса. Канцерогенен при высоких дозах.
