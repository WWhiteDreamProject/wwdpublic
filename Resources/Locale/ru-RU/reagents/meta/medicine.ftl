...
reagent-name-artiplates = пеностат
reagent-desc-artiplates = Также известен как Артпластины. Высокоразвитая форма искусственной крови, которая быстро расширяется при попадании в кровоток. Из-за своих расширяющихся свойств она может вызывать тяжелые внутренние кровотечения при больших дозах.

reagent-name-enunciase = энунциаза
reagent-desc-enunciase = Фермент, который помогает стимулировать языковые центры мозга, облегчая заикание, вызванное другими препаратами, и временно вызывая «идеальную» речь. При больших дозах вызывает тошноту.
