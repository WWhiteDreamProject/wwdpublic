...
reagent-name-ousiana-dust = пыль бытия
reagent-desc-ousiana-dust = Тихий крик отдается эхом от этого порошка, это кувалда для разума, способная насильно пробивать любые психические блоки, но всё имеет свою цену.

reagent-name-formic-acid = муравьиная кислота
reagent-desc-formic-acid = Коррозионно-активное химическое вещество, используемое в производстве ферментов.
