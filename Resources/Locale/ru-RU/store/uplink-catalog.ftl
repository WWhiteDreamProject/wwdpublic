...
uplink-emag-desc = Легендарный "Емаг". Способен открывать электронные замки и вмешиваться в работу различных электронных устройств станции. Заряжается автоматически.
