...
uplink-emag-desc = Этот секвенсор, являющийся визитной карточкой синдиката, способен вмешиваться в работу различных устройств станции. Заряжается автоматически.
