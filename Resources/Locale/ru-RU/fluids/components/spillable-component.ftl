...
spill-target-verb-activate-cannot-drain-message = Вы не можете ничего вытянуть из { $owner }!
spill-target-verb-activate-is-empty-message = В { $owner } пусто!
spill-melee-hit-attacker = Вы проливаете { $amount }ед. реагента { $spillable } на { $target }!
spill-melee-hit-others = { CAPITALIZE($attacker) } выливает часть реагента { $spillable } на { $target }!
