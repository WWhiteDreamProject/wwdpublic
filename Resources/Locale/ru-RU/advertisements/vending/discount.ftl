advertisement-discount-1 = Дискаунтер Дэн, он - мужик!
...
advertisement-discount-8 = Дискаунтер Дэна(tm) не несет ответственности за любой ущерб, вызванный неправильным использованием его продукции.
