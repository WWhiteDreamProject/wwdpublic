...
bwoink-system-introductory-message =
    Подробно опишите проблему, с которой вы столкнулись. Предположим, что администратор игры, решающий проблему, не знает о том, что произошло, из первых рук.
    О любых багах и других связанных проблемах следует сообщать через Discord или, что желательней, Github.
    Неправильное использование этой системы сообщений может бубубу бебебе.
    {""}
...
admin-ahelp-admin-only-tooltip =
    ...
    но будет видно другим администраторам и по-прежнему будет ретранслироваться в Discord.
