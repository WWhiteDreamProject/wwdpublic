...
nukeops-welcome =
    ...
    Смерть NanoTrasen!
nukeops-briefing = Ваши цели просты. Доставьте груз и убедитесь, что он взорвётся. Приступайте к миссии.
...
nukeops-not-enough-ready-players = Недостаточно игроков готовы к игре! { $readyPlayersCount } {RU-PLURAL($readyPlayersCount, "игрок", "игрока", "игроков")} из необходимых { $minimumPlayers } готовых. Нельзя начать режим Ядерных оперативников.
nukeops-no-one-ready = Нет готовых игроков! Нельзя начать режим Ядерных оперативников.
