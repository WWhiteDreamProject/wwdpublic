...
traitor-role-greeting-pda =
    Вы - агент Синдиката.
    Ваши цели и кодовые слова перечислены в меню персонажа.
    Воспользуйтесь аплинком в вашем ПДА, чтобы приобрести всё необходимое для выполнения работы.
    Смерть Nanotrasen!

traitor-role-greeting-implant =
    Вы - агент Синдиката.
    Ваши цели и кодовые слова перечислены в меню персонажа.
    Воспользуйтесь имплантированным аплинком, чтобы приобрести всё необходимое для выполнения работы.
    Смерть Nanotrasen!

traitor-role-greeting-radio =
    Вы - агент Синдиката.
    Ваши цели и кодовые слова перечислены в меню персонажа.
    Воспользуйтесь радио-аплинком, чтобы приобрести всё необходимое для выполнения работы.
    Смерть Nanotrasen!
...
traitor-role-uplink-radio =
    Ваш старомодный радио-аплинк был предоставлен, держите его в безопасности.
    Доступ к нему осуществляется напрямую из вашей руки или инвентаря.
...
traitor-role-uplink-implant-short = Ваш аплинк был имплантирован в ваше тело. Воспользуйтесь им из хотбара.
traitor-role-uplink-radio-short = Вам был предоставлен старомодный радио-аплинк. Доступ к нему осуществляется из вашего инвентаря.
