...
game-ticker-player-join-game-message = Добро пожаловать на Космическую Станцию 14! Если вы играете впервые, обязательно нажмите ESC на клавиатуре и прочитайте правила игры, а также не бойтесь просить помощи в «АХелп» (Админ Помощь), F1 по умолчанию.
...
preset-not-enough-ready-players = Не удалось запустить пресет "{ $presetName }". Требуется { $minimumPlayers } {RU-PLURAL($minimumPlayers, "игрок", "игрока", "игроков")}, но {RU-PLURAL($readyPlayersCount, "готов", "готовы", "готовы")} только { $readyPlayersCount } {RU-PLURAL($readyPlayersCount, "игрок", "игрока", "игроков")}.
