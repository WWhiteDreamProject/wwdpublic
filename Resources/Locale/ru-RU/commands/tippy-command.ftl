...
cmd-tippy-help = tippy <пользователь | all> <сообщение> [время речи] [прототип сущности] [время скольжения] [интервал покачивания]
cmd-tippy-auto-1 = <пользователь | all>
cmd-tippy-auto-2 = сообщение
cmd-tippy-auto-3 = длительность речи (в секундах)
cmd-tippy-auto-4 = прототип сущности
