...
ghost-role-information-familiar-description = Межпространственное существо, подчиняющееся воле псионика.
...
ghost-role-information-space-goldfish-description = Бесцельно плавайте по воздуху и кусайте любого, кто достаточно глуп, чтобы навлечь на себя ваш гнев.
# WWDP EDIT END
...
# WWDP EDIT START
ghost-role-information-minebot-name = Шахтбот
ghost-role-information-minebot-description = Помогайте утилизаторам в их работе.
# WWDP EDIT END
