ghost-respawn-minutes-left = До возможности вернуться в раунд { $time } {RU-PLURAL($time, "минута", "минуты", "минут")}
ghost-respawn-seconds-left = До возможности вернуться в раунд { $time } {RU-PLURAL($time, "секунда", "секунды", "секунд")}
