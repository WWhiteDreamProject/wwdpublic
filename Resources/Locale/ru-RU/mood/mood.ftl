...
mood-effect-HungerPeckish =
    { GENDER($entity) ->
       *[male]    Сейчас я бы перекусил.
        [female]  Сейчас я бы перекусила.
        [epicene] Сейчас мы бы перекусили.
        [neuter]  Сейчас тело бы перекусило.
    }
...
mood-effect-ThirstThirsty =
    { GENDER($entity) ->
        [epicene] Наши губы немного пересохли.
        [neuter]  Губы тела немного пересохли.
       *[other]   Мои губы немного пересохли.
    }
...
mood-effect-HealthLightDamage =
    { GENDER($entity) ->
        [neuter] У тела всего лишь царапина, но всё равно болит.
       *[other]  Это всего лишь царапина, но всё равно болит.
    }
...
mood-effect-MobLowPressure =
    { GENDER($entity) ->
        [epicene] Кажется, мы вот-вот лопнем!
        [neuter]  Кажется, тело вот-вот лопнет!
       *[other]   Кажется, я вот-вот лопну!
    }
...
mood-effect-HeirloomSecure =
    { GENDER($entity) ->
        ...
        [neuter]  Реликвия тела в безопасности, а с ней и воспоминания о тех, кто был до него.
...
# Хирургия
mood-effect-MorphineBenefit = Морфин помогает забыть о боли.
...
mood-effect-PlasmamanIngestPlasma =
    { GENDER($entity) ->
        [epicene] Наши кости омолодились от свежей плазмы, текущей по ним.
        [neuter]  Кости тела омолодилось от свежей плазмы, текущей по нему.
...
mood-effect-DrankInsectBlood =
    { GENDER($entity) ->
       *[male]    Я только что выпил слизкое месиво из насекомого... Это отвратительно!
        [female]  Я только что выпила слизкое месиво из насекомого... Это отвратительно!
        [epicene] Мы только что выпили слизкое месиво из насекомого... Это отвратительно!
        [neuter]  Тело только что выпило слизкое месиво из насекомого... Это отвратительно!
    }
...
mood-effect-MildPainkiller =
    { GENDER($entity) ->
        [epicene] Наши боли и ломота в теле стали чуть слабее.
        [neuter]  Боль и ломота тела стала чуть слабее.
       *[other]   Моя боль и ломота в теле стала чуть слабее.
    }
...
mood-effect-TearGasEffect =
    { GENDER($entity) ->
        ...
        [neuter]  ГЛАЗА ГОРЯТ. ЭТО ТАК БОЛЬНО!
...
mood-effect-SweetenerEffect =
    { GENDER($entity) ->
        [neuter] Телу было очень сладко.
       *[other]  Это было очень сладко.
    }

mood-effect-SpicyEffect =
    { GENDER($entity) ->
        [neuter] Телу было остро, приятно горячо.
       *[other]  Это было остро, приятно горячо.
    }
...
mood-effect-SaltyEffect =
    { GENDER($entity) ->
       *[male]    Я съел что-то солёное. Это было великолепно!
        ...
        [neuter]  Тело съело что-то солёное. Телу понравилось!
    }
...
mood-effect-MintyEffect =
    { GENDER($entity) ->
       *[male]    Я съел что-то мятное. Это было прохладно и освежающе.
        ...
        [neuter]  Тело съело что-то мятное. Телу это показалось прохладным и освежающим.
    }
...
mood-effect-PepperEffect =
    { GENDER($entity) ->
       *[male]    Я съел что-то с перцем. Это было великолепно!
        ...
        [neuter]  Тело съело что-то с перцем. Тело считает это великолепным!
    }
...
mood-effect-ChocolateEffect =
    { GENDER($entity) ->
       *[male]    Я съел что-то с шоколадом. Это было так вкусно!
        ...
        [neuter]  Тело съело что-то с шоколадом. Телу было так вкусно!
    }
...
mood-effect-TastyEffect =
    { GENDER($entity) ->
        [neuter] Телу было действительно вкусно!
       *[other]  Это было действительно вкусно!
    }
