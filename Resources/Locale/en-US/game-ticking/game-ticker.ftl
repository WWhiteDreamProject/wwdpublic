...
game-ticker-get-info-text = Hi and welcome to [color=blue]Space Station 14![/color]
...
game-ticker-get-info-preround-text = Hi and welcome to [color=blue]Space Station 14![/color]
                            The current round is: [color=blue]#{$roundId}[/color]
