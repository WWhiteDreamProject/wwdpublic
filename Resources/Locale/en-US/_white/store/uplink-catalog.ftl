...
random-syndicate-kit-name = Syndicate gear kit
random-syndicate-kit-desc = A randomly selected set of gear built around a certain theme, that is collectively worth more than 25 TC and can include items not regularly available in the uplink. No refunds!
