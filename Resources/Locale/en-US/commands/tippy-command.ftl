...
cmd-tippy-help = tippy <user | all> <message> [speak time] [entity prototype] [slide time] [waddle interval]
cmd-tippy-auto-1 = <user | all>
cmd-tippy-auto-2 = message
cmd-tippy-auto-3 = speak time, in seconds
cmd-tippy-auto-4 = entity prototype
