...
public sealed class PVSIgnoreSystem : EntitySystem
{
    ...
    private void OnStartup(EntityUid uid, PVSIgnoreComponent comp, ComponentStartup args)
    {
        _pvsOverride.AddGlobalOverride(uid);
    }

    private void OnShutdown(EntityUid uid, PVSIgnoreComponent comp, ComponentShutdown args)
    {
