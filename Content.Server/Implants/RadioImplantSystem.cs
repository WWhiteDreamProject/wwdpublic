...
public sealed class RadioImplantSystem : EntitySystem
{
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RadioImplantComponent, SubdermalImplantInserted>(OnImplantImplanted);
    ...
    /// </summary>
    private void OnImplantImplanted(Entity<RadioImplantComponent> ent, ref SubdermalImplantInserted args)
    {
