...
public sealed partial class QuickDialogSystem
{
    ...
    /// <param name="session">Client to show a dialog for.</param>
    /// <param name="title">Title of the dialog.</param>
    /// <param name="prompt">The prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="okAction">The action to execute upon Ok being pressed.</param>
    /// <param name="cancelAction">The action to execute upon the dialog being cancelled.</param>
    /// <typeparam name="T1">Type of the input.</typeparam>
    [PublicAPI]
    public void OpenDialog<T1>(ICommonSession session, string title, (string, string) prompt, Action<T1> okAction,
        Action? cancelAction = null)
    {
        OpenDialogInternal(
            session,
    ...
    /// <param name="session">Client to show a dialog for.</param>
    /// <param name="title">Title of the dialog.</param>
    /// <param name="prompt1">The first prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="prompt2">The second prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="okAction">The action to execute upon Ok being pressed.</param>
    /// <param name="cancelAction">The action to execute upon the dialog being cancelled.</param>
    /// <typeparam name="T1">Type of the first input.</typeparam>
    /// <typeparam name="T2">Type of the second input.</typeparam>
    [PublicAPI]
    public void OpenDialog<T1, T2>(ICommonSession session, string title, (string, string) prompt1, (string, string) prompt2,
        Action<T1, T2> okAction, Action? cancelAction = null)
    {
        OpenDialogInternal(
            session,
    ...
    /// <param name="prompt1">The first prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="prompt2">The second prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="prompt3">The third prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="okAction">The action to execute upon Ok being pressed.</param>
    /// <param name="cancelAction">The action to execute upon the dialog being cancelled.</param>
    /// <typeparam name="T1">Type of the first input.</typeparam>
    /// <typeparam name="T2">Type of the second input.</typeparam>
    /// <typeparam name="T3">Type of the third input.</typeparam>
    [PublicAPI]
    public void OpenDialog<T1, T2, T3>(ICommonSession session, string title, (string, string) prompt1, (string, string) prompt2,
        (string, string) prompt3, Action<T1, T2, T3> okAction, Action? cancelAction = null)
    {
        OpenDialogInternal(
            session,
            title,
    ...
    /// <param name="prompt2">The second prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="prompt3">The third prompt First tuple value is the actual prompt, second is initial value..</param>
    /// <param name="prompt4">The fourth prompt. First tuple value is the actual prompt, second is initial value.</param>
    /// <param name="okAction">The action to execute upon Ok being pressed.</param>
    /// <param name="cancelAction">The action to execute upon the dialog being cancelled.</param>
    /// <typeparam name="T1">Type of the first input.</typeparam>
    /// <typeparam name="T2">Type of the second input.</typeparam>
    ...
    /// <typeparam name="T4">Type of the fourth input.</typeparam>
    [PublicAPI]
    public void OpenDialog<T1, T2, T3, T4>(ICommonSession session, string title, (string, string) prompt1, (string, string) prompt2,
        (string, string) prompt3, (string, string) prompt4, Action<T1, T2, T3, T4> okAction, Action? cancelAction = null)
    {
        OpenDialogInternal(
            session,
            title,
