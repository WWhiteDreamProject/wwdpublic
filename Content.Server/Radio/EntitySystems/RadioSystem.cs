...
public sealed class RadioSystem : EntitySystem
{
        ...
        bool escapeMarkup = false) // WD edit
    {
        ...
        var transformEvent = new TransformRadioSpeakerNameEvent(messageSource, Name(messageSource), channel);
        RaiseLocalEvent(messageSource, ref transformEvent);

        var name = transformEvent.VoiceName;
        ...
        var wrappedMessage = WrapRadioMessage(messageSource, channel, name, content, transformEvent, language, frequency);
        var msg = new ChatMessage(ChatChannel.Radio, content, wrappedMessage, NetEntity.Invalid, null);

        // ... you guess it
        var obfuscated = _language.ObfuscateSpeech(content, language);
        var obfuscatedWrapped = WrapRadioMessage(messageSource, channel, name, obfuscated, transformEvent, language, frequency);
