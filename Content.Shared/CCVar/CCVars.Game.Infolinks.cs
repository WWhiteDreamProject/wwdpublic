...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> InfoLinksDiscord =
        CVarDef.Create("infolinks.discord", "https://discord.gg/4aEEs6ud", CVar.SERVER | CVar.REPLICATED); // MS EDIT

    /// <summary>
    ///     Link to website to show in the launcher.
    /// </summary>
    public static readonly CVarDef<string> InfoLinksForum =
        CVarDef.Create("infolinks.forum", "", CVar.SERVER | CVar.REPLICATED); // MS EDIT

    /// <summary>
    ///     Link to GitHub page to show in the launcher.
    /// </summary>
    public static readonly CVarDef<string> InfoLinksGithub =
        CVarDef.Create("infolinks.github", "https://github.com/tripsov/main-station", CVar.SERVER | CVar.REPLICATED); // MS EDIT
    ...
    public static readonly CVarDef<string> InfoLinksWiki =
        CVarDef.Create("infolinks.wiki", "https://wiki.wwdp.ee/", CVar.SERVER | CVar.REPLICATED); // MS EDIT
