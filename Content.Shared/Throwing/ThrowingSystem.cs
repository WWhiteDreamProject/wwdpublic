...
public sealed class ThrowingSystem : EntitySystem
{
        ...
        bool throwInAir = true) // WWDP
    {
        ...
        TryThrow(uid, mapPos.Position - thrownPos.Position, baseThrowSpeed, user, pushbackRatio, friction, compensateFriction: compensateFriction, recoil: recoil, animated: animated, playSound: playSound, doSpin: doSpin, unanchor: unanchor, throwInAir: throwInAir);
    }
        ...
        bool throwInAir = true)
    {
        ...
        TryThrow(
            ...
            user,
            pushbackRatio,
            friction, compensateFriction: compensateFriction, recoil: recoil, animated: animated, playSound: playSound, doSpin: doSpin, unanchor: unanchor, throwInAir: throwInAir); // WWDP: throw in air
    }
