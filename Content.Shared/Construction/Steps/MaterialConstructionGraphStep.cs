...
namespace Content.Shared.Construction.Steps
{
    ...
    public sealed partial class MaterialConstructionGraphStep : EntityInsertConstructionGraphStep
    {
        ...
        public override void DoExamine(ExaminedEvent examinedEvent)
        {
            ...
            examinedEvent.PushMarkup(Loc.GetString("construction-insert-material-entity", ("amount", Amount), ("materialName", Loc.GetString(material.ID)))); // WWDP EDIT
        }
        ...
        public override ConstructionGuideEntry GenerateGuideEntry()
        {
            ...
            return new ConstructionGuideEntry()
            {
                ...
                Arguments = new (string, object)[]{("amount", Amount), ("material", Loc.GetString(material.ID))}, // WWDP EDIT
                Icon = material.Icon,
            };
        }
    }
