...
namespace Content.Shared._White.BloodCult.PhaseShift;
...
public sealed partial class PhaseShiftedComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier PhaseInSound = new SoundPathSpecifier(new ResPath("/Audio/_White/Magic/BloodCult/veilin.ogg"));

    [DataField]
    public SoundSpecifier PhaseOutSound =
        new SoundPathSpecifier(new ResPath("/Audio/_White/Magic/BloodCult/veilout.ogg"));
