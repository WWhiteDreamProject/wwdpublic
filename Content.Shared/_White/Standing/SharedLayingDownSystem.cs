...
public abstract class SharedLayingDownSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        // SubscribeLocalEvent<LayingDownComponent, CheckAutoGetUpEvent>(OnCheckAutoGetUp); WD edit - no auto get up
    }
    ...
    {
        if (!args.SenderSession.AttachedEntity.HasValue || !TryGetNetEntity(args.SenderSession.AttachedEntity, out var netEntity))
            return;
        ...
        RaiseLocalEvent(uid, new CheckAutoGetUpEvent(netEntity.Value));
    ...
    private void OnRefreshMovementSpeed(EntityUid uid, LayingDownComponent component, RefreshMovementSpeedModifiersEvent args)
    {
        if (_standing.IsDown(uid))
            args.ModifySpeed(component.LyingSpeedModifier, component.LyingSpeedModifier);
        else
