...
public abstract partial class SharedHandsSystem
{
    ...
    public bool TryDrop(EntityUid uid, Hand hand, EntityCoordinates? targetDropLocation = null, bool checkActionBlocker = true, bool doDropInteraction = true, HandsComponent? handsComp = null, double dropAngle = 0) // WWDP
    {
        ...
        TransformSystem.SetWorldPositionRotation(entity, GetFinalDropCoordinates(uid, origin, target, entity), itemRot + dropAngle); // WD EDIT
        return true;
    }
    ...
    /// </summary>
    public Vector2 GetFinalDropCoordinates(EntityUid user, MapCoordinates origin, MapCoordinates target, EntityUid held) // WWDP EDIT // WHY WASN'T THIS PUBLIC
    {
