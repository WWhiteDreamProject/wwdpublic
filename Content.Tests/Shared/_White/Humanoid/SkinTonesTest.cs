...
namespace Content.Tests.Shared._White.Humanoid;
...
public sealed class SkinTonesTest
{
    ...
    // This is for monitoring, even if tests pass due to a large enough Epsilon in production code.
    ...
    public void TestHumanTonedSkinColoration_RoundTrip()
    {
        ...
        for (var i = 0; i <= 10000; i++)
        {
            ...
            Assert.That(
                resultUnary,
                Is.EqualTo(originalUnary).Within(1e-2f), // 1e-2f (0.01) is 1% of the unary range, which is reasonable for rounding and float error.
    ...
    public void TestTintedHuesValidHsl()
    {
        ...
        for (var i = 0; i <= 10000; i++)
        {
            ...
            Assert.That(
                strategy.VerifySkinColor(skinColor),
    ...
    private void LogDriftIfGreater(ISkinColorationStrategy strategy, Color original, Color clamped, string testName)
    {
        switch (strategy)
        {
            case ClampedHslColoration hslStrategy:
            {
            ...
            case ClampedHsvColoration hsvStrategy:
            {
