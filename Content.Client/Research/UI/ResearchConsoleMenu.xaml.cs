...
public sealed partial class ResearchConsoleMenu : FancyWindow
{
    ...
    public void UpdatePanels(ResearchConsoleBoundInterfaceState state)
    {
        ...
        foreach (var techId in database.CurrentTechnologyCards)
        {
            ...
            var cardControl = new TechnologyCardControl(tech, _prototype, _sprite, _research.GetTechnologyDescription(tech, includeTier: false, softCap: state.SoftCapMultiplier), state.Points, state.SoftCapMultiplier, hasAccess);
