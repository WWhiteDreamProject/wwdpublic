...
[UsedImplicitly]
public sealed class TrackedRadialSelectorMenuBUI : BoundUserInterface
{
    ...
    private readonly TrackedRadialMenu _menu;
    ...
    public TrackedRadialSelectorMenuBUI(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
        _spriteSystem = _entManager.System<SpriteSystem>();
        _menu = new TrackedRadialMenu
        {
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        CreateMenu(trackedRadialSelectorState.Entries);

        _trackedEntity = _entManager.GetEntity(trackedRadialSelectorState.TrackedEntity);
    }
