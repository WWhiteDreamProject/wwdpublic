...
public sealed partial class WizardMirrorWindow : DefaultWindow
{
    ...
    public void RefreshSpecies()
    {
        ...
        if (AllowedSpecies != null)
        {
            ...
            if (Profile != null && _prototypeManager.TryIndex<SpeciesPrototype>(Profile.Species, out var prototype) && !_species.Contains(prototype)) // WD edit
    ...
    private void UpdateSexControls()
    {
        ...
        if (_prototypeManager.TryIndex<SpeciesPrototype>(Profile.Species, out var speciesProto)) // WD edit
        {
